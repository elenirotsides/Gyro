		...
		(a.fn.tagsInput = function (e) {
			...
			return (
				this.each(function () {
					if (
						'undefined' ==
						typeof a(this).attr('data-tagsinput-init')
					) {
						...
						if (
							...
							if (
								(a(h.fake_input).val(
									a(h.fake_input).attr('data-default')
								),
								a(h.fake_input).css(
									'color',
									f.placeholderColor
							...
							a(h.fake_input).bind('keypress', h, function (b) {
								return d(b)
									...
									: void (
											b.data.autosize &&
											a(b.data.fake_input).doAutosize(f)
									  );
							}),
								h.removeWithBackspace &&
									a(h.fake_input).bind('keydown', function (
										b
									) {
										if (
											8 == b.keyCode &&
